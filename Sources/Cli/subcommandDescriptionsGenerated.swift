...
let subcommandDescriptions = [
    ...
    ["  stash-picker", "Pick and restore a stashed window"],
    ["  stash", "Stash a window without using macOS minimize or application hide"],
    ...
    ["  unstash", "Restore a stashed window to tiling"],
