...
let accent_help_generated = """
    USAGE: accent [-h|--help] [--window-id <window-id>]
    """
...
let move_workspace_to_monitor_help_generated = """
    USAGE: move-workspace-to-monitor [-h|--help] [--workspace <workspace>] [--swap] [--wrap-around] (left|down|up|right)
       OR: move-workspace-to-monitor [-h|--help] [--workspace <workspace>] [--swap] [--wrap-around] (next|prev)
       OR: move-workspace-to-monitor [-h|--help] [--workspace <workspace>] [--swap] [--] <monitor-pattern>...
    """
