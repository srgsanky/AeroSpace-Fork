...
== accent
----
include::aerospace-accent.adoc[tags=synopsis]
----
include::aerospace-accent.adoc[tags=purpose]
include::aerospace-accent.adoc[tags=body]
...
== built-in-display
----
include::aerospace-built-in-display.adoc[tags=synopsis]
----
include::aerospace-built-in-display.adoc[tags=purpose]
include::aerospace-built-in-display.adoc[tags=body]
...
== stash
----
include::aerospace-stash.adoc[tags=synopsis]
----
include::aerospace-stash.adoc[tags=purpose]
include::aerospace-stash.adoc[tags=body]

== stash-picker
----
include::aerospace-stash-picker.adoc[tags=synopsis]
----
include::aerospace-stash-picker.adoc[tags=purpose]
include::aerospace-stash-picker.adoc[tags=body]
...
== unstash
----
include::aerospace-unstash.adoc[tags=synopsis]
----
include::aerospace-unstash.adoc[tags=purpose]
include::aerospace-unstash.adoc[tags=body]
